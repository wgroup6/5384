Instance: Immunization-uc3
InstanceOf: StructureDefinition
Description: "Data Model for the 'Record a Historic immunization event'"
Title: "UC3: Record a Historic immunization event"
Usage: #definition

* publisher = "ISO/TC 521 WG3"
* status = #draft
* url = "http://iso.org/fhir/ts-5384/StructureDefinition/Immunization-uc3"
* name = "ImmunizationUcHistoricEvent"
* title = "UC3: Record a Historic immunization event"
* status = #draft
* experimental = true
* description = "Data Model for the 'Record a Historic immunization event'"
